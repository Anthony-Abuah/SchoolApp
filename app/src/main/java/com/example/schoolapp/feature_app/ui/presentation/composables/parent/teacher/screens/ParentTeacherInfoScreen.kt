...
import com.example.schoolapp.feature_app.ui.presentation.composables.parent.teacher.ParentTeacherInfoContent

@Composable
fun ParentTeacherInfoScreen(
    navigateBack: () -> Unit,
){
    Scaffold(
        topBar = {
